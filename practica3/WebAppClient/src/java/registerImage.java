...
public class registerImage extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            img.setTitle(request.getParameter("titol"));
            img.setAuthor(request.getParameter("autor"));
            img.setDescription(request.getParameter("descripcio"));
            img.setKeywords(request.getParameter("keywords"));
            img.setCreaDate(request.getParameter("creadate"));
