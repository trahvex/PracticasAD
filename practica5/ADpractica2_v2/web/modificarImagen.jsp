        ...
        <div class="container-fluid">
            ...
            <%
                ...
                out.write("<h2>Modifica:</h2>"
                        ...
                        + "Título:<input type=\"text\" name=\"title\" value = "+titulo+" required> <br><br>"
                        + "Descripción:<input type=\"text\" name=\"description\"value = "+descripcion+" required> <br><br>"
                        + "Palabras clave (separadas por comas y sin espacios):<input type=\"text\" name=\"keyword\"value = "+keywords+" required> <br><br>"
